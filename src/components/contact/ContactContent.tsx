...
export default function ContactContent() {
  ...
  const needPhone = agreeSms || phoneProvided;
  const needSms = phoneProvided;
          ...
          <div style={{ flex: "1 1 480px", minWidth: "300px" }}>
            {!submitted ? (
              ...
              >
                ...
                {/* Consent: checkboxes = affirmative act; notice below = CTIA disclosure record (A2P dual-consent). */}
