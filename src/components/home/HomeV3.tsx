...
const OBJECTIONS: Obj[] = [
  ...
  { q: "“How do I know this’ll work for me?”", a: "We've already been doing this for businesses for years. You’ll see real movement inside the first 90 days — actual leads and calls, not vague promises. We start you small, prove our worth, then build from there. If it’s not making you money, it’s on us to fix. You watch the real-world, money-making improvements you care about: streamlined processes, more phone calls, more high-ticket jobs booked, increased revenue, and much more." },
  { q: "“Is this a cookie-cutter package?”", a: "No. Everyone starts on the same foundation: a professional website, search presence, systems in place, and more. Why? Because delivering excellent results depends on it. But, what we build on top is shaped around your problems, your market, your goals." },
