  ...
  <div style={{maxWidth:'1180px',margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(min(100%,310px),1fr))',gap:'clamp(20px,2.2vw,26px)',alignItems:'stretch'}}>
    ...
    <div style={{background:'rgba(255,255,255,.025)',border:'1px solid rgba(255,255,255,.10)',borderRadius:'18px',padding:'34px 30px',display:'flex',flexDirection:'column',gap:'0'}}>
      ...
      <div style={{display:'flex',flexDirection:'column',gap:'12px',flex:'1'}}>
        ...
        <div style={{width:'100%',height:'1px',background:'rgba(255,255,255,.06)',margin:'6px 0'}}></div>
        <div style={{display:'flex',gap:'10px',alignItems:'flex-start'}}><span style={{color:'#7f8896',fontSize:'14px',lineHeight:'1.6',flex:'none'}}>—</span><span style={{fontSize:'13.5px',lineHeight:'1.6',color:'#7f8896'}}>No AI content/video generation</span></div>
        <div style={{display:'flex',gap:'10px',alignItems:'flex-start'}}><span style={{color:'#7f8896',fontSize:'14px',lineHeight:'1.6',flex:'none'}}>—</span><span style={{fontSize:'13.5px',lineHeight:'1.6',color:'#7f8896'}}>No social media management</span></div>
    ...
    <div style={{position:'relative',background:'linear-gradient(180deg,rgba(128,0,255,.12),rgba(128,0,255,.03)),rgba(255,255,255,.02)',border:'1px solid rgba(128,0,255,.55)',borderRadius:'18px',padding:'34px 30px',display:'flex',flexDirection:'column',boxShadow:'0 0 60px rgba(128,0,255,.16)'}}>
      ...
      <div style={{display:'flex',flexDirection:'column',gap:'12px',flex:'1'}}>
        ...
        <div style={{display:'flex',gap:'10px',alignItems:'flex-start'}}><span style={{color:'#b56bff',fontSize:'14px',lineHeight:'1.6',flex:'none'}}>✓</span><span style={{fontSize:'14px',lineHeight:'1.6',color:'#c8c8c8'}}>Programmatic SEO — hundreds of location + service pages</span></div>
